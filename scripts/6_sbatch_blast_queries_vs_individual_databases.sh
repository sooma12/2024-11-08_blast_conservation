...
#SBATCH --output=/work/geisingerlab/Mark/blast_conservation/2024-11-08_blast_conservation/logs/%x_%A_%a.log
#SBATCH --error=/work/geisingerlab/Mark/blast_conservation/2024-11-08_blast_conservation/logs/%x_%A_%a.err
